                    ...
                    <div class="card-body">
                      ...
                      <ul class="nav nav-tabs" id="myTab" role="tablist">
                            ...
                            <form id="modeloForm" name="modeloForm" class="form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    Marca: <br>
                                           <select name="selmarca" id="selmarca" class="form-control">
                                            ...
                                            <option  {{ $marcas->id == $modelo->id_marca ? 'selected' : '' }} value="{{$marcas->id}}">{{$marcas->nombre}}</option>
                                            @endforeach
                                           </select>
                                 </div>
                               ...
                               <div class="form-group">
                                Nombre: <br>
                               <input type="text" class="form-control" id="txtnombre" name="txtnombre" placeholder="Ingrese Nombre" value="{{ $modelo->nombre }}" required >
                               </div>
                              <div class="form-group">
                                Desccripcion:
                                <br>
                               <input type="text" class="form-control" id="txtdescripcion" name="txtdescripcion" placeholder="Ingrese Descripcion" value="{{ $modelo->descripcion }}" required >
                               </div>
                               <br>
