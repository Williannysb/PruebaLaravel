                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home"
                                    type="button" role="tab" aria-controls="home" aria-selected="true">Listado de
                                    propietarios</button>
                            </li>
                                        ...
                                        @foreach ($propietario as $propietario)
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <a href="{{ route('propietario.edit', $propietario->id) }}"
                                                                class="btn btn-primary">
                                                                <i class="fas fa-trash"></i>Editar</a>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <form
                                                                action="{{ route('propietario.destroy', $propietario->id) }}"
                                                                method="POST">
                                                                @csrf
                                                                @method('DELETE')
