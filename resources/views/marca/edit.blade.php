                      ...
                      <ul class="nav nav-tabs" id="myTab" role="tablist">
                            ...
                            <form id="marcaForm" name="marcaForm" class="form-horizontal">
                               ...
                               <div class="form-group">
                                Nombre: <br>
                               <input type="text" class="form-control" id="txtnombre" name="txtnombre" placeholder="Ingrese Nombre" value="{{ $marca->nombre }}" required />
                               </div>
                              <div class="form-group">
                                Desccripcion:
                                <br>
                               <input type="text" class="form-control" id="txtdescripcion" name="txtdescripcion" placeholder="Ingrese Descripcion" value="{{ $marca->descripcion }}" required/>
                               </div>
                               <br>
